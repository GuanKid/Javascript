  ...
  // Advanced Pasta Recipes
{
    ...
    instructions: "1. Cook spaghetti according to package instructions. 2. In a separate pan, fry bacon until crispy. 3. Whisk eggs, Parmesan cheese, and black pepper in a bowl. 4. Drain spaghetti and toss with bacon and egg mixture."
  },
  {
    name: "Fettuccine Alfredo",
    ingredients: ["fettuccine", "butter", "heavy cream", "Parmesan cheese", "salt", "pepper"],
    instructions: "1. Cook fettuccine according to package instructions. 2. In a saucepan, melt butter over medium heat. 3. Add heavy cream, Parmesan cheese, salt, and pepper. 4. Cook until sauce thickens. 5. Toss cooked fettuccine in the sauce."
  },
  {
    ...
    instructions: "1. Cook the lobster meat and chop it into small pieces. 2. Cook the ravioli pasta according to package instructions. 3. In a pan, melt butter and sauté shallots. 4. Add white wine and reduce. 5. Add heavy cream, lemon zest, and lemon juice. 6. Stir in lobster meat and cooked ravioli. 7. Season with salt, pepper, and garnish with parsley."
  },
  {
